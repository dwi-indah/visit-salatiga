...
export default function Heading({ title, subtitle, desc, link, linkAddress }) {
    return(
        <div className="flex flex-col lg:flex-row lg:items-end gap-4 justify-between mb-16">
            ...
            <div className="text-gray-600 lg:max-w-md lg:text-xl mt-6">
                {desc}
                <Link to={`/${linkAddress}`} className="group inline-flex gap-1 py-2 items-center text-primary font-bold border-b-1 hover:border-b-2 lg:text-2xl transition duration-300">
                    {link}
